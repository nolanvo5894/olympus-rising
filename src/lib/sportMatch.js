...
export const PERSONALITY_QUESTIONS = [
  { id: "pressure", q: "When the stakes peak, your mind…",
    choices: [
      "Locks in — narrow focus, everything else disappears.",
      "Lights up — the pressure is fuel, you attack harder.",
      "Stays loose — trust the prep and let the body flow.",
      "Reads the moment — adapt to whatever it asks.",
    ] },
  { id: "training", q: "Where do you train best?",
    choices: [
      "Outdoors — trails, water, or open air.",
      "In the gym, working a coach's program.",
      "On a court or field, scrimmaging live opponents.",
      "In a quiet studio, perfecting one motion at a time.",
    ] },
  { id: "body", q: "What does your body do best?",
    choices: [
      "Explosive power — sprint, jump, throw.",
      "Sustained endurance — go for hours.",
      "Fine precision — hand-eye, balance, touch.",
      "Raw strength — lift heavy, hold heavy.",
    ] },
  { id: "risk", q: "How do you learn a new physical skill?",
    choices: [
      "Watch a master closely, then mirror it.",
      "Break it into pieces and drill each one.",
      "Jump in and figure it out through reps.",
      "Study the theory and mechanics first.",
    ] },
  { id: "win", q: "What kind of contest do you want to win?",
    choices: [
      "A timed race — fastest across the line.",
      "A judged performance — perfect form scores.",
      "A head-to-head match — beat the person across from you.",
      "A team competition — lift the trophy together.",
    ] },
];
